...
ESPM metrics provide users a reliable view of performance that can reported to comply with local regulations. However, ESPM metrics are only available when data is complete, error-free and the following conditions are met:
