...
sidebarTitle: "Adding and Editing Data Coverage"
...
To edit  data coverage values, users must first open the appropriate **Whole Building** or **Space-based** data coverage sidebar for the target property (l[earn more](index)).
...
<Steps>
  ...
  <Step title="Review Assigned Meters">
    ...
    | ------------------- | ------------------------------------------------------------------------------------------- |
    | Whole Building      | All in-metric meters associated with the property ([learn more](/meters/meter-status))      |
    | Spaces              | All meters assigned to specific space types ([learn more](/meters/meter-space-assignments)) |
  </Step>
