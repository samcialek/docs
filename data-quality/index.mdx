...
- **Property level**: Issues summary, data completeness (%), data coverage (%), annual jumps, high & low values
...
In general, the following algorithm is followed with extensions for each specific data quality metric:
...
<Steps>
  ...
  <Step title="Individual daily gaps and overlaps are calculated for each meter">
    Every missing and overlapping day between all entries for each meter is identified and indexed over all time.
  </Step>
...
<CardGroup cols={1}>
  ...
  <Card title="Overlaps" icon="clone" href="/data-quality/overlaps">
    Identify overlapping utility data entries across all meters.
  </Card>
  <Card title="Jumps" icon="clone" href="/data-quality/jumps">
    Quickly spot potentially anomalous changes in data over time.
  </Card>
</CardGroup>
