---
title: "Abisko Meter Types"
sidebarTitle: "Meter Types"
description: "Types of energy, water, and waste meters tracked in Abisko."
icon: "wave-square"
---
...
<Note>
  Abisko allows users to track energy, water, and waste data in any supported unit (see below) and to select the units used for analysis and performance reporting.
</Note>
